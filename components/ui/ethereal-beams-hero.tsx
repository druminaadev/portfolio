...
const BeamsBackground = dynamic(() => import('./BeamsBackground'), { 
  ssr: false,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center">
              <span className="text-xl font-bold text-white">DRUMINAA</span>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl max-w-3xl mx-auto">
              Transforming complex problems into elegant solutions through modern architecture, AI integration, and scalable system design.
            </p>
